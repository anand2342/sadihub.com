...
const ToastItem: React.FC<{ toast: ToastMessage; onClose: () => void }> = ({ toast, onClose }) => {
  ...
  return (
    <div className="pointer-events-auto bg-[var(--bg-card)] border border-[var(--border-gold)] rounded-xl p-4 shadow-xl flex items-center gap-3 backdrop-blur-md transition-all duration-300 animate-slide-up">
      {icons[toast.type]}
